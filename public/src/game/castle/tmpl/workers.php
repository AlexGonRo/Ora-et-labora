...
$content_html = render_content($workers, $available_tasks, $occupied, $total_space);
...
function render_content($workers, $available_tasks, $occupied, $total_space){ 
    ob_start();
    ?>
        <div class="content_block">
            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <?php foreach ($workers as $worker) { ?>
                    ...
                    <td class="centered_td"> <?php echo $worker['strength']; ?></td>
                    <td class="centered_td"> <?php echo $worker['dexterity']; ?> </td>
                    <td class="centered_td"> <?php echo $worker['charisma']; ?> </td>
